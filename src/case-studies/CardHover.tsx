export default function CardHover() {
  return (
    <div className="center-container">
      <a
        href="#"
        className="size-[340px] bg-[#fafafa] border border-[#fff] rounded-2xl flex items-end shadow-cardhover-container overflow-hidden hover:[&>div]:transform-[translateY(0)] focus-visible:[&>div]:transform-[translateY(0)]"
      >
        <div
          className="m-(--margin) border-[#fff] border rounded-xl relative bg-[#fafafa] space-y-1 w-full py-2.5 px-3.5 shadow-cardhover-description transform-[translateY(calc(100%+var(--margin)+1px))] ease-out duration-200 transition-transform"
          style={{ "--margin": "6px" } as React.CSSProperties}
        >
          <h3 className="font-medium">Project name</h3>
          <p className="text-[#717175] ">Project description</p>
          <svg
            width="11"
            height="11"
            viewBox="0 0 11 11"
